...
<body>
    ...
    <div class="container1">
        <div class="signin">
            <h2>Form Penjadwalan Konsultasi</h2>
            <p>Privasi dan kerahasiaanmu aman</p>
            <p>Silahkan Menggunakan nama samaran jika penasaran jika merasa lebih nyaman tetap anonim</p>
        </div>
        <div class="signup">
            <h2>Buat Akun</h2>
